...
// ------------------------------------------------------------
// LocationCode -> "Auction house · CITY" mapping (your block)
// (Keep exactly as you pasted it)
// ------------------------------------------------------------
const LOCATION_LOOKUP = { /* ... YOUR 197 ENTRIES ... */ };
...
function locationLabel(code){
  ...
  if(raw.includes("·")){
    ...
    const city = cityRaw.toLowerCase().replace(/\b\w/g, l => l.toUpperCase());
    return `${house} (${city})`;
  }
  return raw;
}
